...
const Projects = React.forwardRef<HTMLDivElement, ProjectsProps>((props, ref) => {
    // Use the useStaticQuery hook to fetch data from GraphQL

    // Render your component content here
    return (
        <div ref={props.refProp} className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
